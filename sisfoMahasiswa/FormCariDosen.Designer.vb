...
Partial Class FormCariDosen
    ...
    Private Sub InitializeComponent()
        ...
        ColumnHeaderNIDN = New ColumnHeader()
        ColumnHeaderNama = New ColumnHeader()
        ColumnHeaderTelp = New ColumnHeader()
        ...
        ListView1.Columns.AddRange(New ColumnHeader() {ColumnHeaderNIDN, ColumnHeaderNama, ColumnHeaderTelp, ColumnHeaderEmail})
        ...
        ' ColumnHeaderNIDN
        ' 
        ColumnHeaderNIDN.Text = "NIDN"
        ColumnHeaderNIDN.Width = 100
        ' 
        ' ColumnHeaderNama
        ' 
        ColumnHeaderNama.Text = "Nama Dosen"
        ColumnHeaderNama.Width = 180
        ' 
        ' ColumnHeaderTelp
        ' 
        ColumnHeaderTelp.Text = "Telp/HP"
        ColumnHeaderTelp.Width = 120
        ' 
        ' ColumnHeaderEmail
        ' 
    ...
    Friend WithEvents ColumnHeaderNIDN As ColumnHeader
